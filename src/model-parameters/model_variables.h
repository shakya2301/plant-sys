...
const char* ei_classifier_inferencing_categories[] = { "Healthy", "Needs Water", "Overwatered", "Too Cold", "Too Humid", "Too Much Sun" };

EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_2_axes[] = { 0, 1, 2, 3, 4, 5, 6 };
const uint32_t ei_dsp_config_2_axes_size = 7;
ei_dsp_config_raw_t ei_dsp_config_2 = {
    2, // uint32_t blockId
    1, // int implementationVersion
    7, // int length of axes
    4.0f // float scale-axes
};
...
const ei_impulse_t impulse_670731_0 = {
    .project_id = 670731,
    .project_owner = "kavyashakya",
    .project_name = "plant_new_data",
    .impulse_id = 1,
    ...
    .fusion_string = "temperature + humidity + log_light + moisture_smooth + temp_hum_ratio + ETI_Sigmoid + VPD_Column",
    .slice_size = (1/4),
...
ei_impulse_handle_t impulse_handle_670731_0 = ei_impulse_handle_t( &impulse_670731_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_670731_0;
